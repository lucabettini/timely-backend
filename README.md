...
The API serves 34 endpoints in total to the [main website](https://time-ly.netlify.app) built with React, all successfully [tested](https://github.com/lucabettini/timely-backend/tree/main/tests/Feature) with PhpUnit, using [factories](https://github.com/lucabettini/timely-backend/tree/main/database/factories) to inject provisional records in the MySQL database.
